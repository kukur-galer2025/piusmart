            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <textarea name="address" id="address" rows="3" placeholder="{{ __('address_placeholder') }}"
                              class="w-full pl-11 pr-4 py-2.5 text-sm text-gray-900 dark:text-white bg-gray-50 dark:bg-slate-900 border @error('address') border-rose-500 dark:border-rose-500 @else border-gray-200 dark:border-slate-600 @enderror rounded-xl focus:outline-none focus:ring-2 @error('address') focus:ring-rose-500 @else focus:ring-emerald-500 @enderror focus:bg-white dark:focus:bg-slate-800">{{ old('address') }}</textarea>
                </div>
