...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div>
        ...
        <h1 class="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900 dark:text-white mt-2">{{ __('add_new_customer') }}</h1>
    </div>
        ...
        <form action="{{ route('customers.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <div class="relative min-w-0">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="{{ __('name_placeholder') }}"
            ...
            <div>
                ...
                <div class="relative min-w-0">
                    ...
                    <input type="text" name="phone" id="phone" value="{{ old('phone') }}" placeholder="{{ __('phone_placeholder') }}"
            ...
            <div>
                ...
                <div class="relative min-w-0">
                    ...
                    <textarea name="address" id="address" rows="3" placeholder="{{ __('address_placeholder') }}"
                              class="w-full min-w-0 pl-10 pr-3 py-2.5 text-sm text-gray-900 dark:text-white bg-gray-50 dark:bg-slate-900 border @error('address') border-rose-500 dark:border-rose-500 @else border-gray-200 dark:border-slate-600 @enderror rounded-xl focus:outline-none focus:ring-2 @error('address') focus:ring-rose-500 @else focus:ring-emerald-500 @enderror focus:bg-white dark:focus:bg-slate-800 resize-none">{{ old('address') }}</textarea>
                </div>
