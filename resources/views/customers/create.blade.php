...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div>
        ...
        <h1 class="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900 dark:text-white mt-2 transition-colors">Tambah Pelanggan Baru</h1>
    </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <textarea name="address" id="address" rows="3" placeholder="Masukkan alamat lengkap..."
                              class="w-full pl-11 pr-4 py-2.5 text-sm text-gray-900 dark:text-white bg-gray-50 dark:bg-slate-900 border @error('address') border-rose-500 dark:border-rose-500 @else border-gray-200 dark:border-slate-600 @enderror rounded-xl focus:outline-none focus:ring-2 @error('address') focus:ring-rose-500 @else focus:ring-emerald-500 @enderror focus:bg-white dark:focus:bg-slate-800 transition-colors">{{ old('address') }}</textarea>
                </div>
