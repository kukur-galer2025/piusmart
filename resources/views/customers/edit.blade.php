...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div>
        ...
        <h1 class="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900 mt-2">Edit Data Pelanggan</h1>
    </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <textarea name="address" id="address" rows="3"
                              class="w-full pl-11 pr-4 py-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:bg-white transition-all">{{ old('address', $customer->address) }}</textarea>
                </div>
