    ...
    <div class="bg-white dark:bg-slate-800 p-5 sm:p-6 md:p-8 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm overflow-hidden">
        <form action="{{ route('receivables.update', $receivable->id) }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <div class="flex items-center w-full px-3 py-2.5 text-sm bg-gray-100 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl text-gray-500 dark:text-gray-400 cursor-not-allowed select-none min-w-0 overflow-hidden">
                    ...
                    <span class="truncate font-medium text-gray-600 dark:text-gray-300 min-w-0">{{ $receivable->customer->name }} (📞 {{ $receivable->customer->phone ?? '-' }})</span>
                </div>
            ...
            <div>
                ...
                <div class="relative min-w-0">
                    ...
                    <input type="text" name="item_name" id="item_name" value="{{ old('item_name', $receivable->item_name) }}" required placeholder="{{ __('item_name_placeholder') }}"
