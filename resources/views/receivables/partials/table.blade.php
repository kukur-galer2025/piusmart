                ...
                <tr class="hover:bg-gray-50/70 dark:hover:bg-slate-800/50">
                    ...
                    <td class="px-6 py-4 text-center whitespace-nowrap">
                        <div class="flex items-center justify-center gap-2">
                            ...
                            <a href="{{ route('receivables.show', $item->id) }}" title="{{ __('view_details') }}" class="p-1.5 text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 rounded-lg hover:bg-blue-600 dark:hover:bg-blue-600 hover:text-white dark:hover:text-white border border-blue-200 dark:border-blue-800/50 cursor-pointer">
